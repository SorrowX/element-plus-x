  ...
  return {
    ...
    resolve: {
      alias: [
        ...
        {
          find: /^element-plus-x\/dist\/locale\/zh-cn.mjs$/,
          replacement: `${pkgRoot}/locale/lang/zh-cn`,
        },
        {
          find: /^element-plus-x\/dist\/locale\/en.mjs$/,
          replacement: `${pkgRoot}/locale/lang/en`,
        },
      ],
    },
    server: {
